defmodule SlackCloneWeb.AuthLive do
        ...
        <div class="max-w-md w-full">
          ...
          <div class="mt-8 pt-8 border-t border-gray-200">
            <div class="text-center">
              ...
              <a href="#" class="ml-1 font-medium text-purple-600 hover:text-purple-700">
                Create an account
              </a>
            </div>
          </div>
  ...
  def handle_event("sign_in", %{"email" => email, "password" => password}, socket) do
    case Accounts.authenticate_user(email, password) do
      {:ok, user} ->
        ...
        workspace = SlackClone.Workspaces.get_user_first_workspace(user)
        
        {:noreply,
         socket
         |> put_flash(:info, "Welcome back!")
         |> redirect(to: ~p"/workspace/#{workspace.id}")}
