defmodule SlackCloneWeb.ChannelCase do
  @moduledoc """
  ...
  tests asynchronously by setting `use SlackCloneWeb.ChannelCase, async: true`,
  ...
  using do
    quote do
      ...
      import SlackCloneWeb.ChannelCase
  ...
  setup tags do
    SlackClone.DataCase.setup_sandbox(tags)
    :ok
  end
end