...
class ProgressModal extends obsidian_1.Modal {
    ...
    onOpen() {
        ...
        this.progressBar = new obsidian_1.ProgressBarComponent(progressBarContainer);
        ...
        this.cancelButton = new obsidian_1.ButtonComponent(buttonContainer);
        this.cancelButton
        ...
        this.closeButton = new obsidian_1.ButtonComponent(buttonContainer);
        this.closeButton
            .setButtonText('Close')
            .setCta()
            .setDisabled(true)
    ...
    setComplete() {
        ...
        new obsidian_1.Notice('Notion import completed successfully!');
    }
    setError(error) {
        this.isCompleted = true;
        ...
        // Show error notice
        new obsidian_1.Notice(`Import failed: ${error}`, 0);
    }
...
class ConfirmCancelModal extends obsidian_1.Modal {
    ...
    onOpen() {
        ...
        const cancelButton = new obsidian_1.ButtonComponent(buttonContainer);
        cancelButton
        ...
        const confirmButton = new obsidian_1.ButtonComponent(buttonContainer);
        confirmButton
